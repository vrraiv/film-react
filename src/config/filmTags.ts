...
export const FILM_TAGS: FilmTag[] = [
  ...
  { id: 'legal', label: 'Legal', category: 'genre_form' },
  { id: 'holiday', label: 'Holiday', category: 'genre_form' },
  { id: 'historical_period', label: 'Historical / Period', category: 'genre_form' },
  { id: 'epic', label: 'Epic', category: 'genre_form' },
  ...
  { id: 'suspenseful', label: 'Suspenseful', category: 'tone_mood' },
  { id: 'dreamlike', label: 'Dreamlike', category: 'tone_mood' },
  { id: 'playful', label: 'Playful', category: 'tone_mood' },
  { id: 'earnest', label: 'Earnest', category: 'tone_mood' },
  { id: 'sentimental', label: 'Sentimental', category: 'tone_mood' },
  { id: 'uplifting', label: 'Uplifting', category: 'tone_mood' },
  ...
  { id: 'whimsical', label: 'Whimsical', category: 'tone_mood' },
  { id: 'menacing', label: 'Menacing', category: 'tone_mood' },
  { id: 'meditative', label: 'Meditative', category: 'tone_mood' },
  { id: 'exuberant', label: 'Exuberant', category: 'tone_mood', description: 'High-energy, joy-forward tone marked by celebratory momentum and expressive emotional intensity.' },
  { id: 'gritty', label: 'Gritty', category: 'tone_mood' },
  ...
  { id: 'classical', label: 'Classical', category: 'style_craft' },
  { id: 'polished', label: 'Polished', category: 'style_craft' },
